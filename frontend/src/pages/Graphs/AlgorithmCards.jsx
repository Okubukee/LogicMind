...
const AlgorithmCards = ({ algorithmsInfo, onSelectAlgorithm }) => {
  const algorithms = Object.values(algorithmsInfo);
      ...
      <div style={{ textAlign: 'center', marginBottom: '48px' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', marginBottom: '16px' }}>
          ...
          <h2 style={{ fontSize: '32px', fontWeight: 'bold', color: 'white' }}>
            Elige un algoritmo de Grafos
          </h2>
        </div>
        <p style={{ color: '#9ca3af', maxWidth: '600px', margin: '0 auto' }}>
          Los algoritmos de grafos permiten recorrer, buscar caminos y analizar estructuras de datos conectadas.
        </p>
      </div>
